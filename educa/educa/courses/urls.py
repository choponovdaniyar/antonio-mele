...
from .views import ContentDeleteView, CourseListView, ManageCourseListView, CourseCreateView,\
                    CourseDeleteView, CourseUpdateView, CourseModuleUpdate, \
                    ContentCreateUpdateView, ModuleContentListView, ModuleOrderView, ContentOrderView, \
                    CourseDetailView
...
urlpatterns = [
    ...
    path("<pk>/module/", CourseModuleUpdate.as_view(), name="course_module_update"),
